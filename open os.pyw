...
a1.place(x=10,y=10)
a2 = tk.Button(win,text='播放器',command=n.bfj)
a2.place(x=10,y=50)
def gettime():
...
def ks():
          ...
          az1.place(x=10,y=30)
          tk.Label(win1,text='工具').pack()
          az2 = tk.Button(win1,text='open os播放器',command=n.bfj)
          az2.place(x=10,y=60)
...
a13.place(x=0,y=790)
a14 = tk.Button(win,text='pyexe',command=pyexe)
a14.place(x=10,y=330)
